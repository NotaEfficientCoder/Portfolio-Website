  ...
  return (
    <div className='text-white bg-red-500 h-1/5 flex flex-row justify-between '>
        ...
        <div className = "border-2 border-black w-1/2 flex flex-row">
            <BiLogoTailwindCss className = "w-20 h-20 bg-blue-500 p-2 m-1 rounded-full"/>
            <AiFillHtml5 className = "w-20 h-20 bg-orange-500 p-2 m-1 rounded-full"/>
            <SiNextdotjs className = "w-[75px] h-[75px] p-2 m-1 bg-black rounded-xl"/>
        </div>
